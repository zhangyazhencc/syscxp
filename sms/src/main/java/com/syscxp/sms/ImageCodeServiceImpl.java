...
public class ImageServiceImpl extends AbstractService implements ImageService, ApiMessageInterceptor {

    private static final CLogger logger = Utils.getLogger(ImageServiceImpl.class);
    ...
    public void handleMessage(Message msg) {
        ...
        if (msg instanceof APIGetImageMsg) {
