...
import com.syscxp.tunnel.host.MonitorAgentCommands.ConnectCmd;
import com.syscxp.tunnel.host.MonitorAgentCommands.ConnectResponse;
import com.syscxp.tunnel.host.MonitorAgentCommands.PingCmd;
import com.syscxp.tunnel.host.MonitorAgentCommands.PingResponse;
...
//                        String srcPath = String.format("%s/files/monitor/%s", AnsibleConstant.ROOT_DIR, agentPackageName);
                        ...
                        runner.putArgument("tunnel_server_url", CoreGlobalProperty.TUNNEL_MONITOR_SERVER_URL);
    ...
    protected HostVO updateHost(APIUpdateHostMsg msg) {
        ...
        if (umsg.getMonitorType() != null) {
            vo.setMonitorType(umsg.getMonitorType());
        }
