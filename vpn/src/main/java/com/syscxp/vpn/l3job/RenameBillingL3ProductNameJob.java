...
@RestartableJob
@UniqueResourceJob
public class RenameBillingL3ProductNameJob implements Job {
    private static final CLogger logger = Utils.getLogger(RenameBillingL3ProductNameJob.class);
    ...
    public static RenameBillingL3ProductNameJob executeJob(JobQueueFacade jobf, String resourceUuid, String resourceName){
        RenameBillingL3ProductNameJob job = new RenameBillingL3ProductNameJob();
