...
@RestartableJob
@UniqueResourceJob
public class DeleteL3RenewVOAfterDeleteL3ResourceJob implements Job {
    private static final CLogger logger = Utils.getLogger(DeleteL3RenewVOAfterDeleteL3ResourceJob.class);
    ...
    public void run(ReturnValueCompletion<Object> completion) {
        ...
        try {
            logger.info("开始执行JOB【清除L3RenewVO】");
    ...
    public static DeleteL3RenewVOAfterDeleteL3ResourceJob execute(JobQueueFacade jobf, String resourceUuid, String accountUuid){
        DeleteL3RenewVOAfterDeleteL3ResourceJob job = new DeleteL3RenewVOAfterDeleteL3ResourceJob();
