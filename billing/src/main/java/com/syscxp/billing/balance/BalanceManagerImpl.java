...
public class BalanceManagerImpl extends AbstractService implements ApiMessageInterceptor {
    ...
    private void handle(APIUpdateAccountBalanceMsg msg) {
        ...
        if (msg.getPresent() != null) {
            ...
            new DealDetailVOHelper(dbf).saveDealDetailVO(msg.getAccountUuid(), DealWay.PRESENT_BILL, msg.getPresent(), BigDecimal.ZERO, dbf.getCurrentSqlTime(), DealType.PRESENT, DealState.SUCCESS, vo.getPresentBalance(), msg.getTradeNO(), outTradeNO, msg.getSession().getAccountUuid(),msg.getComment(),null);
