...
INSERT INTO `syscxp_account`.`PolicyVO` (`uuid`, `name`, `description`, `permission`, `type`, `sortId`, `accountType`, `lastOpDate`, `createDate`) VALUES ('BillingReadOnlyAccess', '只读访问费用中心的权限', NULL, '{"actions":["order:read","recharge:read","receipt:read","renew:read","sla:read"],"effect":"Allow"}', 'billing', '0', 'Normal', '2017-09-12 12:29:38', '2017-09-12 12:29:38');
INSERT INTO `syscxp_account`.`PolicyVO` (`uuid`, `name`, `description`, `permission`, `type`, `sortId`, `accountType`, `lastOpDate`, `createDate`) VALUES ('NodeFullAccess', '管理节点权限', NULL, '{"actions":["node:.*"],"effect":"Allow"}', 'tunnel', '1', 'SystemAdmin', '2017-09-12 12:29:38', '2017-09-12 12:29:38');
INSERT INTO `syscxp_account`.`PolicyVO` (`uuid`, `name`, `description`, `permission`, `type`, `sortId`, `accountType`, `lastOpDate`, `createDate`) VALUES ('NodeReadOnlyAccess', '只读访问节点的权限', NULL, '{"actions":["node:read"],"effect":"Allow"}', 'tunnel', '0', 'SystemAdmin', '2017-09-12 12:29:38', '2017-09-12 12:29:38');
INSERT INTO `syscxp_account`.`PolicyVO` (`uuid`, `name`, `description`, `permission`, `type`, `sortId`, `accountType`, `lastOpDate`, `createDate`) VALUES ('SwitchFullAccess', '管理交换机权限', NULL, '{"actions":["switch:.*","node:read"],"effect":"Allow"}', 'tunnel', '1', 'SystemAdmin', '2017-09-12 12:29:38', '2017-09-12 12:29:38');
INSERT INTO `syscxp_account`.`PolicyVO` (`uuid`, `name`, `description`, `permission`, `type`, `sortId`, `accountType`, `lastOpDate`, `createDate`) VALUES ('SwitchReadOnlyAccess', '只读访问交换机的权限', NULL, '{"actions":["switch:read"],"effect":"Allow"}', 'tunnel', '0', 'SystemAdmin', '2017-09-12 12:29:38', '2017-09-12 12:29:38');
INSERT INTO `syscxp_account`.`PolicyVO` (`uuid`, `name`, `description`, `permission`, `type`, `sortId`, `accountType`, `lastOpDate`, `createDate`) VALUES ('TunnelFullAccess', '管理专线网络权限', NULL, '{"actions":["tunnel:.*","node:read","monitor:.*"],"effect":"Allow"}', 'tunnel', '1', 'Normal', '2017-09-12 12:29:38', '2017-09-12 12:29:38');
INSERT INTO `syscxp_account`.`PolicyVO` (`uuid`, `name`, `description`, `permission`, `type`, `sortId`, `accountType`, `lastOpDate`, `createDate`) VALUES ('TunnelHostFullAccess', '管理监控主机权限', NULL, '{"actions":["tunnelHost:.*","node:read"],"effect":"Allow"}', 'tunnel', '1', 'SystemAdmin', '2017-09-12 12:29:38', '2017-09-12 12:29:38');
INSERT INTO `syscxp_account`.`PolicyVO` (`uuid`, `name`, `description`, `permission`, `type`, `sortId`, `accountType`, `lastOpDate`, `createDate`) VALUES ('TunnelHostReadOnlyAccess', '只读访问监控主机的权限', NULL, '{"actions":["tunnelHost:read"],"effect":"Allow"}', 'tunnel', '0', 'SystemAdmin', '2017-09-12 12:29:38', '2017-09-12 12:29:38');
INSERT INTO `syscxp_account`.`PolicyVO` (`uuid`, `name`, `description`, `permission`, `type`, `sortId`, `accountType`, `lastOpDate`, `createDate`) VALUES ('TunnelReadOnlyAccess', '只读访问专线网络的权限', NULL, '{"actions":["tunnel:read","node:read","monitor:read"],"effect":"Allow"}', 'tunnel', '0', 'Normal', '2017-09-12 12:29:38', '2017-09-12 12:29:38');
INSERT INTO `syscxp_account`.`PolicyVO` (`uuid`, `name`, `description`, `permission`, `type`, `sortId`, `accountType`, `lastOpDate`, `createDate`) VALUES ('UserFullAccess', '管理User的权限', NULL, '{"actions": ["user:.*"],"effect":"Allow"}', 'account', '2', 'Normal', '2017-09-12 12:29:38', '2017-09-12 12:29:38');
INSERT INTO `syscxp_account`.`PolicyVO` (`uuid`, `name`, `description`, `permission`, `type`, `sortId`, `accountType`, `lastOpDate`, `createDate`) VALUES ('VPNFullAccess', '管理VPN权限', NULL, '{"actions":["vpn:.*"],"effect":"Allow"}', 'vpn', '1', 'Normal', '2017-09-12 12:29:38', '2017-09-12 12:29:38');
INSERT INTO `syscxp_account`.`PolicyVO` (`uuid`, `name`, `description`, `permission`, `type`, `sortId`, `accountType`, `lastOpDate`, `createDate`) VALUES ('VPNReadOnlyAccess', '只读访问VPN权限', NULL, '{"actions":["vpn:read"],"effect":"Allow"}', 'vpn', '0', 'Normal', '2017-09-12 12:29:38', '2017-09-12 12:29:38');
