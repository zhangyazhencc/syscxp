...
@Inventory(mappingVOClass = AuthorityVO.class)
...
public class AuthorityInventory {
    ...
    public static AuthorityInventory valueOf(AuthorityVO vo) {
    ...
    public static List<AuthorityInventory> valueOf(Collection<AuthorityVO> vos) {
