...
public class JsonSchemaBuilder {
    ...
    private void build(Object o, Stack<String> paths) throws IllegalAccessException {
        ...
        for (Field f : fields) {
            ...
            } else if (value.getClass().getCanonicalName().startsWith("com.syscxp")) {
    ...
    // support Map and com.syscxp.* objects
    public Map<String, String> build() {
        try {
            if (!object.getClass().getName().startsWith("com.syscxp") && !(object instanceof Map)) {
                throw new CloudRuntimeException(String.format("only a com.syscxp.* object can be built schema, %s is not", object.getClass()));
            }
