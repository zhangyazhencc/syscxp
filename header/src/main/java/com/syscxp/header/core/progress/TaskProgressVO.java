...
public class TaskProgressVO {
    ...
    @Column
    @com.syscxp.header.vo.ForeignKey(parentEntityClass = ManagementNodeVO.class, parentKey = "uuid", onDeleteAction = ForeignKey.ReferenceOption.SET_NULL)
