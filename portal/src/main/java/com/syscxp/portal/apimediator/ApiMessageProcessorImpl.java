...
import com.syscxp.header.apimediator.GlobalApiMessageInterceptor.InterceptorPosition;
...
public class ApiMessageProcessorImpl implements ApiMessageProcessor {
    ...
    public ApiMessageProcessorImpl(Map<String, Object> config) {
        ...
        try {
            JAXBContext context = JAXBContext.newInstance("com.syscxp.portal.apimediator.schema");
