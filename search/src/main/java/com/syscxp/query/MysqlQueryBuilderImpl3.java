...
import com.syscxp.header.query.*;
...
/**
 */
public class MysqlQueryBuilderImpl3 implements Component, QueryBuilder, GlobalApiMessageInterceptor {
    ...
    private void populateEntityInfo() throws NoSuchMethodException {
        List<Class> metaClasses = BeanUtils.scanClass("com.syscxp", StaticMetamodel.class);
        ...
        List<Class> invClasses = BeanUtils.scanClass("com.syscxp", Inventory.class);
    ...
    public boolean start() {
        try {
            List<Class> queryMessageClasses = BeanUtils.scanClassByType("com.syscxp", APIQueryMessage.class);
