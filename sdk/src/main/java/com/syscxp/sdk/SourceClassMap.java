    ...
    final static HashMap<String, String> srcToDstMapping = new HashMap() {
        {
			...
			put("com.syscxp.header.tunnel.tunnel.OutsideResourceInventory", "com.syscxp.sdk.OutsideResourceInventory");
    ...
    final static HashMap<String, String> dstToSrcMapping = new HashMap() {
        {
			...
			put("com.syscxp.sdk.OutsideResourceInventory", "com.syscxp.header.tunnel.tunnel.OutsideResourceInventory");
