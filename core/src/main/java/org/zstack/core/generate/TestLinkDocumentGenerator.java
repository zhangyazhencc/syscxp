...
import org.zstack.core.generate.schema.RequirementCategory;
import org.zstack.core.generate.schema.RequirementSpecification;
...
public class TestLinkDocumentGenerator {
    ...
    private static void requirmentSpecFromXml(String outputDir, String filePath) throws JAXBException, ClassNotFoundException, IOException {
        JAXBContext context = JAXBContext.newInstance("org.zstack.core.generate.schema");
