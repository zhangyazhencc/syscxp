...
import com.syscxp.core.generate.schema.RequirementCategory;
import com.syscxp.core.generate.schema.RequirementSpecification;
...
public class TestLinkDocumentGenerator {
    ...
    private static void requirmentSpecFromXml(String outputDir, String filePath) throws JAXBException, ClassNotFoundException, IOException {
        JAXBContext context = JAXBContext.newInstance("com.syscxp.core.generate.schema");
