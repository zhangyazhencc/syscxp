...
import com.syscxp.core.componentloader.ComponentLoader;
import com.syscxp.core.config.GlobalConfigFacade;
import com.syscxp.core.errorcode.ErrorFacade;
import com.syscxp.core.statemachine.StateMachine;
import com.syscxp.core.statemachine.StateMachineImpl;
...
import com.syscxp.core.componentloader.ComponentLoaderImpl;
import com.syscxp.core.db.DatabaseGlobalProperty;
import com.syscxp.header.Component;
import com.syscxp.header.core.encrypt.ENCRYPT;
...
public class Platform {
        ...
        for (Field f : clz.getDeclaredFields()) {
            ...
            if (Map.class.isAssignableFrom(f.getType())) {
                ...
                if (ret.isEmpty() && at.required()) {
                    throw new IllegalArgumentException(String.format("A required global property[%s] missing in syscxp.properties", name));
                }
                valueToSet = ret;
    ...
    private static void prepareDefaultDbProperties() {
        if (DatabaseGlobalProperty.DbUrl != null) {
            ...
            if (getGlobalProperty("DbFacadeDataSource.jdbcUrl") == null) {
                ...
                System.setProperty("DbFacadeDataSource.jdbcUrl", dbUrl);
                logger.debug(String.format("default DbFacadeDataSource.jdbcUrl to DB.url [%s]", dbUrl));
            }

            if (getGlobalProperty("RESTApiDataSource.jdbcUrl") == null) {
                String url = DatabaseGlobalProperty.DbRestUrl;
    ...
    static {
        try {
            ...
            reflections = new Reflections(ClasspathHelper.forPackage("com.syscxp"),
            ...
            File globalPropertiesFile = PathUtil.findFileOnClassPath("syscxp.properties", true);
