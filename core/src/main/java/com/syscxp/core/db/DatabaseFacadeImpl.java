...
import com.syscxp.core.db.TransactionalCallback.Operation;
...
import com.syscxp.header.vo.SoftDeletionCascade;
import com.syscxp.header.vo.SoftDeletionCascades;
...
public class DatabaseFacadeImpl implements DatabaseFacade, Component {
    ...
    @PersistenceUnit(unitName = "syscxp.jpa")
    private EntityManagerFactory entityManagerFactory;
    @PersistenceContext(unitName = "syscxp.jpa")
