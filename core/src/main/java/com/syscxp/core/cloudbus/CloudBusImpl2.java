...
import com.syscxp.core.MessageCommandRecorder;
import com.syscxp.core.Platform;
import com.syscxp.core.componentloader.PluginRegistry;
import com.syscxp.core.jmx.JmxFacade;
import com.syscxp.core.thread.*;
import com.syscxp.core.thread.ThreadFacadeImpl.TimeoutTaskReceipt;
import com.syscxp.core.timeout.ApiTimeoutManager;
import com.syscxp.header.Constants;
import com.syscxp.header.Service;
import com.syscxp.header.apimediator.APIIsReadyToGoMsg;
import com.syscxp.header.apimediator.APIIsReadyToGoReply;
...
import com.syscxp.header.exception.CloudConfigureFailException;
...
import com.syscxp.header.search.APISearchReply;
import com.syscxp.utils.*;
...
import static com.syscxp.utils.BeanUtils.getProperty;
import static com.syscxp.utils.BeanUtils.setProperty;
...
public class CloudBusImpl2 implements CloudBus, CloudBusIN, ManagementNodeChangeListener, CloudBusMXBean {
    ...
    private void prepareStatistics() {
        List<Class> needReplyMsgs = BeanUtils.scanClassByType("com.syscxp", NeedReplyMessage.class);
