    ...
    public PluginRegistry getPluginRegistry() {
        ...
        if (pluginRegistry == null) {
            try {
                ...
                logger.debug("if you are running unit test, this exception is safe. The reason is beans you load in unittest don't have syscxp plugin declaration, so PluginRegistry won't create", e);
                return null;
            }
