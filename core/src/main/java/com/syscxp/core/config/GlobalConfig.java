...
import com.syscxp.core.cloudbus.EventCallback;
import com.syscxp.core.cloudbus.EventFacade;
import com.syscxp.core.config.GlobalConfigCanonicalEvents.UpdateEvent;
...
public class GlobalConfig {
    ...
    public static GlobalConfig valueOf(com.syscxp.core.config.schema.GlobalConfig.Config c) {
        GlobalConfig conf = new GlobalConfig();
