...
public aspect ThreadAspect {
    ...
    pointcut syncThread(Object entity) : target(entity) && execution(@com.syscxp.core.thread.SyncThread void java.lang.Object+.*(..));
    
    pointcut syncThreadFuture(Object entity) : target(entity) && execution(@com.syscxp.core.thread.SyncThread Future<java.lang.Void> java.lang.Object+.*(..));

    pointcut asyncThread() : execution(@com.syscxp.core.thread.AsyncThread void java.lang.Object+.*(..));
    
    pointcut asyncThreadFuture() : execution(@com.syscxp.core.thread.AsyncThread Future<java.lang.Void> java.lang.Object+.*(..));

    pointcut scheduledThread() : execution(@com.syscxp.core.thread.ScheduledThread void java.lang.Object+.*(..));
    
    pointcut scheduledThreadFuture() : execution(@com.syscxp.core.thread.ScheduledThread Future<java.lang.Void> java.lang.Object+.*(..));
