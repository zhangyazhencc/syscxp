package com.syscxp.core.errorcode;

import com.syscxp.core.errorcode.schema.Error;
import com.syscxp.header.errorcode.ErrorCode;
import com.syscxp.header.errorcode.ErrorCodeList;
...
public class ErrorFacadeImpl implements ErrorFacade {
    ...
    private void createErrorCode(Error error, String path) {
    ...
    void init() {
        try {
            JAXBContext context = JAXBContext.newInstance("com.syscxp.core.errorcode.schema");
            ...
            for (String p : paths) {
                ...
                Error error =
                        (Error) unmarshaller.unmarshal(cfg);
