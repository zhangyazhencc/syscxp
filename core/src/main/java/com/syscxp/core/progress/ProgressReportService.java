...
import com.syscxp.core.db.SQLBatch;
import com.syscxp.core.db.SimpleQuery;
import com.syscxp.core.errorcode.ErrorFacade;
import com.syscxp.core.thread.PeriodicTask;
import com.syscxp.core.thread.ThreadFacade;
import com.syscxp.header.core.progress.*;
...
import static com.syscxp.core.Platform.toI18nString;
...
public class ProgressReportService extends AbstractService implements ManagementNodeReadyExtensionPoint {
    ...
    private void setThreadContext(ProgressCommands.ProgressReportCmd cmd) {
    ...
    public boolean start() {
        restf.registerSyncHttpCallHandler(ProgressConstants.PROGRESS_REPORT_PATH, ProgressCommands.ProgressReportCmd.class, new SyncHttpCallHandler<ProgressCommands.ProgressReportCmd>() {
            @Override
            public String handleSyncHttpCall(ProgressCommands.ProgressReportCmd cmd) {
    ...
    private TaskProgressInventory inventory(TaskProgressVO vo) {
        ...
        if (vo.getArguments() == null) {
            inv.setContent(Platform.toI18nString(vo.getContent()));
        } else {
            List<String> args = JSONObjectUtil.toCollection(vo.getArguments(), ArrayList.class, String.class);
            inv.setContent(Platform.toI18nString(vo.getContent(), args.toArray()));
        }
