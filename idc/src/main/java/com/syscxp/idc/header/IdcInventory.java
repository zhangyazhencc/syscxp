...
@Inventory(mappingVOClass = IdcVO.class)
public class IdcInventory {
    ...
    public static IdcInventory valueOf(IdcVO vo){
        IdcInventory inv = new IdcInventory();
    ...
    public static List<IdcInventory> valueOf(Collection<IdcVO> vos) {
        List<IdcInventory> invs = new ArrayList<>(vos.size());
        for (IdcVO vo : vos) {
            invs.add(IdcInventory.valueOf(vo));
        }
        return invs;
    }
